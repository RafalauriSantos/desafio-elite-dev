    ...
    <div className="w-full bg-[#111113] p-6 sm:p-8 rounded-2xl border border-zinc-800/60 space-y-6">
      ...
      <div className="text-center">
        <div className="mx-auto max-w-md py-2 rounded-b-2xl bg-zinc-800/50 border-b-2 border-emerald-500/40">
          <span className="text-[11px] uppercase tracking-widest font-medium text-zinc-500">Palco</span>
        </div>
      </div>
        ...
        {rows.map((rowName) => {
          ...
          return (
            <div key={rowName} className="flex items-center gap-2.5">
              <span className="w-5 text-center text-xs text-zinc-600 font-mono font-medium">
                {rowName}
              </span>
              ...
              <div className="flex gap-2">
                {rowSeats.map((seat) => {
                  ...
                  if (isSold) {
                    ...
                    style = 'bg-emerald-500 text-zinc-950 border-emerald-400 ring-2 ring-emerald-500/30 scale-110 z-10 font-semibold';
      ...
      {/* Legend */}
      <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-zinc-800/40 text-[11px] text-zinc-500">
