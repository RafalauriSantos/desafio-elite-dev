...
import { Camera, CheckCircle2, QrCode, ChevronDown, ChevronUp } from 'lucide-react';
...
export const QRScanner: React.FC<QRScannerProps> = ({ targetEventId, onResult }) => {
  ...
  const handleValidate = async (data: string) => {
    ...
    try {
      ...
      // Safe optional chaining for Haptic Feedback (iOS / Safari compatibility)
      if (res.valid) {
      ...
      {mode === 'camera' ? (
        ...
        <div className="space-y-3 pt-1">
          <textarea
            ...
            placeholder='Cole o payload JSON, link do ingresso ou escanie via câmera...'
